...
export default function MenuListBox({ onClose }) {
  const items = [
    { label: "Cart", icon: <AiOutlineShoppingCart className="text-cyan-700" /> },
    { label: "Favorites", icon: <AiOutlineHeart className="text-cyan-700" /> },
    { label: "About us", icon: <AiOutlineInfoCircle className="text-cyan-700" /> },
    { label: "Contact us", icon: <AiOutlinePhone className="text-cyan-700" /> },
    { label: "Order Tracking", icon: <AiOutlineGift className="text-cyan-700" /> },
    { label: "Order History", icon: <AiOutlineGift className="text-cyan-700" /> },
  ];
